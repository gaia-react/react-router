...
| `app/services/gaia/index.server.ts`                        | Remove things import. Leave as `export default {}`                                                                                                                     |
| `app/services/gaia/urls.ts`                                | Remove `things` and `thingsId` keys. Leave as `export const GAIA_URLS = {}`                                                                                            |
| `app/languages/en/pages/index.ts`                          | Remove things import and export                                                                                                                                        |
| `app/languages/en/pages/_index.ts`                         | Remove `serviceExample` and `techStack` keys (keep `meta` and `title`)                                                                                                 |
| `test/mocks/index.ts`                                      | Remove things import. Leave handlers as empty `[]`                                                                                                                     |
| `test/mocks/database.ts`                                   | Remove things import. Leave as empty factory `factory({})`                                                                                                             |
...
| `wiki/modules/State.md`                  | (a) In the JSX snippet, remove the `<ExampleProvider initialState={example}>...</ExampleProvider>` wrapper. (b) Delete the `ExampleProvider` row from the Bundled providers table.                                                                                                                                                                                                                                                                              |
...
| `wiki/modules/Testing.md`                | On the Playwright sample tests bullet, leave only `language-switch.spec.ts` (drop `things.spec.ts`). In the `mocks/` row, remove `things/`.                                                                                                                                                                                                                                                                                                                     |
| `wiki/modules/MSW.md`                    | Delete the `├── things/             # same shape` line from the folder-layout code fence.                                                                                                                                                                                                                                                                                                                                                                       |
